...
/**
 * 使用CollapsingToolbarLayout时，帮助修改TabLayout的背景颜色
 */
class TabLayoutScrimHelper(private val mTabLayout: TabLayout, private val mToolbarLayout: CollapsingToolbarLayout) : AppBarLayout.OnOffsetChangedListener {
