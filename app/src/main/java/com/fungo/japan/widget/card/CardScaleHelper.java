...
public class CardScaleHelper {
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (dx != 0) {//去掉奇怪的内存疯涨问题
                    ...
                    LogUtils.INSTANCE.d(String.format("dx=%s, dy=%s, mScrolledX=%s", dx, dy, mCurrentItemOffset));
    ...
    private void initWidth() {
        mRecyclerView.post(new Runnable() {
            ...
            public void run() {
                ...
                mCardWidth = mCardGalleryWidth - ViewUtils.INSTANCE.dp2px(mContext,2 * (mPagePadding + mShowLeftCardWidth));
    ...
    private void computeCurrentItemPos() {
        ...
        if (pageChanged) {
            ...
            LogUtils.INSTANCE.d(String.format("=======onCurrentItemPos Changed======= tempPos=%s, mCurrentItemPos=%s", tempPos, mCurrentItemPos));
        }
    }
    ...
    private void onScrolledChangedCallback() {
        ...
        LogUtils.INSTANCE.d(String.format("offset=%s, percent=%s", offset, percent));
        View leftView = null;
        View currentView;
        View rightView = null;
